...
avg_daily_mast_on_taking_money = st.number_input('Average Daily Mast on Taking Money', min_value=0.0, max_value=5.0, value=0.01, step=0.01, format="%.2f")
avg_daily_mast_not_taking_money = st.number_input('Average Daily Mast Not Taking Money', min_value=0.0, max_value=5.0, value=2.0, step=0.1, format="%.2f")
